...
function peg$parse(input, options) {
  ...
  var peg$f26 = function (checks) {
    return { type: "checks", checks };
  };
  var peg$f27 = function (head, check) {
    return check;
  };
  var peg$f28 = function (head, tail) {
    return [head, ...tail];
  };
  var peg$f29 = function (expression, settings) {
    return { expression, settings };
  };
  var peg$f30 = function (name, settings, items) {
    return { type: "group", name, items, settings };
  };
  var peg$f31 = function (head, item) {
    return item;
  };
  var peg$f32 = function (head, tail) {
    return [head, ...tail];
  };
  var peg$f33 = function (option) {
    return { type: "option", option };
  };
  var peg$f34 = function (name) {
    return { type: "table", ...name };
  };
  var peg$f35 = function (name, from, cardinality, to, settings) {
    return { type: "ref", cardinality, from, to, settings };
  };
  var peg$f36 = function (n) {
    return n;
  };
  var peg$f37 = function (n) {
    return n;
  };
  var peg$f38 = function (schemaTable, columns) {
    return { ...schemaTable, columns };
  };
  var peg$f39 = function (name) {
    return [name];
  };
  var peg$f40 = function (head, name) {
    return name;
  };
  var peg$f41 = function (head, tail) {
    return [head, ...tail];
  };
  var peg$f42 = function (columns) {
    return columns;
  };
  var peg$f43 = function (name, items) {
    return { type: "enum", ...name, items };
  };
  var peg$f44 = function (head, item) {
    return item;
  };
  var peg$f45 = function (head, tail) {
    return [head, ...tail].filter((i) => i);
  };
  var peg$f46 = function (name, settings) {
    return { type: "value", name, settings };
  };
  var peg$f47 = function (schema, name) {
    return { schema, name };
  };
  ...
  var peg$f58 = function (comment) {
    return { type: "comment", comment };
  };
  var peg$f59 = function (comment) {
    return comment;
  };
  var peg$f60 = function () {
    return "";
  };
  var peg$f61 = function (comment) {
    return comment;
  };
  var peg$f62 = function (head, c) {
    return c;
  };
  var peg$f63 = function (head, tail) {
    return [head, ...tail].join("");
  };
  var peg$f64 = function (pairs) {
    return pairs;
  };
  var peg$f65 = function (head, setting) {
    return setting;
  };
  var peg$f66 = function (head, tail) {
    return [head, ...tail].reduce((a, b) => Object.assign(a, b), {});
  };
  var peg$f67 = function (key, v) {
    return v;
  };
  ...
  var peg$f72 = function (head, opt) {
    return opt;
  };
  var peg$f73 = function (head, tail) {
    return [head, ...tail].reduce((a, b) => Object.assign(a, b), {});
  };
  var peg$f74 = function (key, value) {
    return { [key]: value };
  };
  var peg$f75 = function (key, value) {
    return { [key]: value };
  };
